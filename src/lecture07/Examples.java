...
//        myMap.put("User1", "Pass11");
//        myMap.put("User2", "Pass1");
//        myMap.put("User3", "Pass2");
//        for (Map.Entry<String, String> fruit : myMap.entrySet()) {
...
//        }
    ...
    public static void testHashMapEntrySet() {
        ...
        peshoMap.put(33, "Grapes");
        peshoMap.put(0, "Grapes");
    ...
    public static void testHashSetOperations() {
        ...
        HashSet<String> myHashSetWomen = new HashSet<>();
        myHashSetWomen.add("Ekaterina");
        myHashSetWomen.add("Maya");
        myHashSet.addAll(myHashSetWomen);
        System.out.println("Updated List: " + myHashSet);

        // Removing all the new elements from HashSet
        myHashSet.removeAll(myHashSetWomen);
        System.out.println("After invoking removeAll() method: " + myHashSet);

        // Removing elements on the basis of specified condition
        myHashSet.removeIf(eachEntry -> eachEntry.contains("i"));
