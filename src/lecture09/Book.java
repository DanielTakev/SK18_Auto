...
public class Book {
    ...
    public static void staticMethodDisplayTotalBooks() {
    ...
    public static void main(String[] args) {
        ...
        Book bookDefault = new Book("Harper Lee", 10.99);

        Book.staticMethodDisplayTotalBooks();
