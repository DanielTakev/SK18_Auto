...
//        demoConstructors();
        ...
        System.out.println(daniPingvina.age);
        System.out.println(daniPingvina.isEngaged);
        System.out.println(daniPingvina.name);
    }

    public static void demoObjectCreation() {
        Cake vanillaCake = new Cake("Choco", 2, 2);
        vanillaCake.printDetails();

        Cake vanillaCake333 = new Cake("Choco111", 2);
        vanillaCake333.printDetails();

        Cake vanillaCake2 = new Cake();
        vanillaCake2.printDetails();
    }
